...
open class Tag: Hashable {
    ...
    public var hashValue: Int {
        ...
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_isBlock ? 1 : 0).partialValue
//        result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _isBlock ? 1 : 0).0
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_formatAsBlock ? 1 : 0).partialValue
//        result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _formatAsBlock ? 1 : 0).0
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_canContainBlock ? 1 : 0).partialValue
//        result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _canContainBlock ? 1 : 0).0
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_canContainInline ? 1 : 0).partialValue
//        result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _canContainInline ? 1 : 0).0
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_empty ? 1 : 0).partialValue
//        result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _empty ? 1 : 0).0
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_selfClosing ? 1 : 0).partialValue
//        result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _selfClosing ? 1 : 0).0
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_preserveWhitespace ? 1 : 0).partialValue
//        result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _preserveWhitespace ? 1 : 0).0
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_formList ? 1 : 0).partialValue
//        result = Int.addWithOverflow(Int.multiplyWithOverflow(31, result).0, _formList ? 1 : 0).0
        result = result.multipliedReportingOverflow(by: 31).partialValue.addingReportingOverflow(_formSubmit ? 1 : 0).partialValue
